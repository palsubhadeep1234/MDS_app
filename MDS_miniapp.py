...
# st.markdown(""" <style> .font {font-size:20px ; font-family: 'Times New Roman'; color: #000000;} </style> """, unsafe_allow_html=True)

# # Maximum and minimum values of seven input features to normalize the input value
# max_height = 87.0;
# min_height = 69.0;
...
# st.write('<p class="font">__Enter player statistics__</p>', unsafe_allow_html=True)
# height = st.slider('<p class="font">Height (in inch)<p>', max_height, min_height, step=0.1)
